            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <?php if(!isset($_SESSION["MemberNickName"])): ?>
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="/Project2/WebAPI/LoginPage"   >會員登入</a></li>
                        <li><a href="/Project2/WebAPI/RegisterPage">會員註冊</a></li>
                    </ul>
                <?php else: ?>
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="Login.php?Logout=1">會員登出</a></li>
                        <li><a href="Register.php"      ><?php echo $_SESSION["MemberNickName"]; ?></a></li>
                    </ul>
                <?php endif; ?>
            </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
